...
def faceDetection(test_img):
    ...
    face_haar_cascade=cv2.CascadeClassifier('C:/python/Smart_with_tablet_camera/FaceRecognition-master/HaarCascade/haarcascade_frontalface_default.xml')#Load haar classifier
