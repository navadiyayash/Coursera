...
test_img=cv2.imread('C:/python/FaceRecognition-master/TestImages/Kangana.jpg')#test_img path
...
#face_recognizer.write('C:/python/FaceRecognition-master/trainingData.yml')
